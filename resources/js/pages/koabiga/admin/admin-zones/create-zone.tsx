...
export default function CreateZone({ availableLeaders = [] }: CreateZoneProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await router.post('/koabiga/admin/admin-zones', {
                ...formData,
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: 'Create Zone', href: '/koabiga/admin/admin-zones/create' }
        ]}>
            ...
            <div className="flex h-full flex-1 flex-col items-center justify-center gap-6 p-6">
                ...
                <div className="text-center space-y-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Create New Zone</h1>
                    </div>
                </div>
                ...
                <div className="w-full max-w-2xl space-y-2">
                    ...
                    <div className="flex justify-start">
                        <Button
                            variant="outline"
                            size="sm"
                            onClick={() => router.visit('/koabiga/admin/admin-zones')}
                        >
